...
function get_brandlist()
{
    ...
    if ($result === false)
    {
        ...
        if (isset($_POST['brand_name']))
        {
            ...
            $sql = " SELECT v.id,v.serial,v.group_number,v.card_number,v.card_type,v.using_status,v.allot_status,u.true_name,u.phone
                        FROM ".$GLOBALS['ecs']->table('vip_card'). " v ".
                         " LEFT JOIN  edo_cp_vip_card_issue cis ".
                        " ON v.id = cis.vip_card_id ".
                        " LEFT JOIN edo_user u ".
                        " ON cis.user_id=u.uid ".
