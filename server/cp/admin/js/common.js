...
{
	var imgstr = "";
	imgstr="<iframe border=0 width='430' height='450' src='earth.html?longitude=longitude&latitude=latitude&distance=radius' scrolling='no' frameborder=0></iframe>";
	var a = new xWin("1", 440, 480, 300,20,"Google Earth",imgstr);
	//var b = new xWin("2",100,200,300,100,"arui2","test2");
}
function getBaiduEarth()
{
  var imgstr = "";
  imgstr="<iframe border=0 width='800' height='350' src='baiduMap.html' scrolling='no' frameborder=0></iframe>";
  var a = new xWin("1", 440, 480, 100,20,"BaiDu Earth",imgstr);
  //var b = new xWin("2",100,200,300,100,"arui2","test2");
}
