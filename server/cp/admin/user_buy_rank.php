...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('ur_here',      $_LANG['05_member_buy_rank']);
    ...
    assign_query_info();
    $smarty->display('user_buy_rank.htm');
}
...
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('user_buy_rank.htm'));
}
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    assign_query_info();
    $smarty->display('user_buy_rank_info.htm');
}
...
elseif ($_REQUEST['act'] == 'updata')
{
    ...
    $param = "`id`='$_POST[id]',name = '$_POST[name]',  point='$_POST[point]'";
    ...
    if ($db->query($sql))
    {
        ...
        admin_log($_POST['name'], 'edit', 'user_buy_rank');
