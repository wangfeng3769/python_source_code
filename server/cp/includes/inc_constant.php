...
define('OS_CANCELED',               3); // 已取消
define('OS_INVALID',                2); // 无效
define('OS_RETURNED',               4); // 退货
define('OS_SPLITED',                5); // 已分单
define('OS_SPLITING_PART',          6); // 部分分单
*/

define('OS_UNCONFIRMED',            0); // 未支付
define('OS_CONFIRMED',              1); // 已预定
define('OS_INVALID',                2); // 执行中
define('OS_RETURNED',               3); // 已完成
define('OS_CANCELED',               4); // 已取消
define('OS_SPLITED',                5); // 支付超时
define('OS_SPLITING_PART',          6); // 还车超时
define('OS_LOCK',                   8); // 已锁门
define('OS_CHECK_OUT',              9); // 已结算
