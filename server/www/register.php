...
<span class="zhuce-1-1"><p class="denglu-1-2" style="width:150px">密码：</p><input id="password" name="" type="password" class="zhuce-sr"  style="width:225px" /></span>
<span class="zhuce-1-1"><p class="denglu-1-2" style="width:150px">密码确认：</p><input id="password_again" name="" type="password" class="zhuce-sr"  style="width:225px" /><p class="hongtishi" style="color:red;display:none" >两次密码输入不一致</p></span>
<!--<span class="zhuce-1-1"><p class="denglu-1-2" style="width:240px"><input name="" type="checkbox" value="" class="dl-dx" style=" margin:0 0 0 150px" />记住密码</p></span>-->
...
<span class="zhuce-1-1"><p class="denglu-1-2" style="width:320px"><input name="" type="checkbox" value="" class="dl-dx" style=" margin:0 0 0 150px" /><a href="#" class="xieyi">我同意易多服务协议</a></p></span>
...
<p class="zhuce-txt" style="width:355px">调用系统短信功能发送zc到服务号码。</p>
<p class="zhuce-txt" style="width:187px">服务号码：</p>
<p class="zhuce-txt-2" style="width:330px; margin:20px 0 0 0">移动：106575203009510370</p>
<p class="zhuce-txt-2" style="width:320px; margin:20px 0 0 2px">联通：10655059382510370</p>
<p class="zhuce-txt-2" style="width:330px; margin:20px 0 0 0">电信：106590256995810370</p>
<p class="zhuce-txt" style="width:364px; margin:20px 0 0 0">仅运营商收取短信费0.1元，无额外费用</p>
</div>
</div>
