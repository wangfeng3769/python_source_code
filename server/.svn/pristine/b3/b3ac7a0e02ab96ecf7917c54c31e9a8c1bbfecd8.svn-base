...
$config->APPID		= '226530';	//你的API Key，请自行申请
$config->APIKey		= '95c3f649c13740868e8f604583ee4a28';	//你的API Key，请自行申请
$config->SecretKey	= '2c04bc98d4c74adf8afc9ad9e1dc438d';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= 'http://www.eduoauto.com/openPlatForm/renren/callback.php';//你的获取code的回调地址，也是accesstoken的回调地址
$config->scope='publish_feed,photo_upload,publish_share';
?>