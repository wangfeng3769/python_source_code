...
<?php include 'header.html';?>
	<div class="zhuce">
<div class="zhuce-1">登陆成功</div>
<div class="renzheng-1" style=" margin: 10px 10px 10px 200px" >
<p class="chengse24-2" align="center" style="margin-left:80px;">我们更新了《易多第三方服务协议》，请确认是否同意该协议。 </p>

<span class="zhuce-1-1"><p class="denglu-1-2" style="width:320px"><a href="#" class="xieyi">阅读易多服务协议</a></p></span>
<span class="zhuce-1-1"><p class="denglu-1-2" style="width:106px; margin-left:150px;"><a id="vBtnConfirm" href="#" class="anniu-xgmm">同意</a></p><p class="denglu-1-2" style="width:106px; margin-left:20px;"><a id="vBtnConfirm" href="#" class="anniu-xgmm">不同意</a></p></span>
