...
$_LANG['rank_name'] = '会员消费等级名称';
$_LANG['integral_min'] = '积分下限';
$_LANG['integral_max'] = '积分上限';
$_LANG['discount'] = '初始折扣率';
$_LANG['add_user_rank'] = '添加会员消费等级';
$_LANG['special_rank'] = '特殊会员组';
$_LANG['show_price'] = '在商品详情页显示该会员消费等级的商品价格';
$_LANG['notice_special'] = '特殊会员组的会员不会随着积分的变化而变化。';
$_LANG['add_continue'] = '继续添加会员消费等级';
$_LANG['back_list'] = '返回会员消费等级列表';
$_LANG['show_price_short'] = '显示价格';
$_LANG['notice_discount'] = '请填写为0-100的整数,如填入80，表示初始折扣率为8折';

$_LANG['rank_name_exists'] = '会员消费等级名 %s 已经存在。';
$_LANG['add_rank_success'] = '会员消费等级已经添加成功。';
$_LANG['integral_min_exists'] = '已经存在一个等级积分下限为 %d 的会员消费等级';
$_LANG['integral_max_exists'] = '已经存在一个等级积分上限为 %d 的会员消费等级';
$_LANG['add_rank_success'] = '会员消费等级已经添加成功。';
$_LANG['rankedit_succed'] = '会员消费等级\'%s\'已经修改成功。';

/* JS 语言 */
$_LANG['js_languages']['remove_confirm'] = '您确定要删除选定的会员消费等级吗？';
$_LANG['js_languages']['rank_name_empty'] = '您没有输入会员消费等级名称。';
