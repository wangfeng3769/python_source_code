...
$_LANG['app_name'] = 'EDOAUTO';
$_LANG['cp_home'] = 'EDOAUTO 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2012-2022 易多，并保留所有权利。';
...
$_LANG['04_category_add'] = '添加车辆';
$_LANG['05_comment_manage'] = '用户评论';
$_LANG['06_goods_brand_list'] = '商品品牌' ;
$_LANG['06_goods_brand_list'] = '站点管理' ;
$_LANG['06_equite_list'] = '设备管理' ;
$_LANG['07_brand_add'] = '添加品牌' ;
$_LANG['07_equipment_add'] = '添加设备' ;
...
$_LANG['53_suppliers_goods'] = '车群组商品管理';
...
$_LANG['05_coupon_list'] = '优惠券管理';
$_LANG['coupontype_add'] = '添加优惠券类型';
$_LANG['coupon_add'] = '添加会员红包';
/* 订单管理 */

$_LANG['01_order_config'] = '订单原则';
...
$_LANG['04_invoice_list'] = '发票列表';
$_LANG['11_car_bug_list'] = '未还车列表';
$_LANG['12_settle_list'] = '结算列表';
...
$_LANG['022_suppliers_list'] = '车群组管理';
$_LANG['06_car_group_list'] = '车群组管理';
/* 系统设置 */
...
$_LANG['01_car'] = '资源管理' ;
$_LANG['01_car_list'] = '车辆管理' ;
$_LANG['01_car_add'] = '添加车辆' ;
$_LANG['02_station_list'] = '站点管理' ;
$_LANG['03_equipment_list'] = '设备管理' ;
$_LANG['06_suppliers_list'] = '车群管理' ;
//add by golf 油卡管理
$_LANG['04_oil_card'] = '油卡管理' ;
$_LANG['04_oil_card_add'] = '添加油卡' ;
/*add by golf sim卡管理*/
$_LANG['05_sim_card_list'] = 'sim卡管理';
$_LANG['05_sim_card_add'] = '添加sim卡' ;

$_LANG['11_vip_card_issue'] = '会员卡发放';
$_LANG['11_vip_card_list'] = '会员卡管理';

$_LANG['06_car_price_tmpl'] = '车辆定价模板管理';
$_LANG['03_billing_strategy'] = '计费策略管理';
$_LANG['01_calendar_setting'] = '日历设置';
$_LANG['05_violate'] = '违章管理';
/*---------------------------------------------*/
$_LANG['03_member_list'] = '会员信息管理';
$_LANG['12_approve_list'] = '注册审核管理';

/*押金策略管理*/
$_LANG['03_deposit_strategy'] = '押金策略管理';
$_LANG['01_deposit_config'] = '使用押金配置';
$_LANG['02_deposit_strategy_list'] = '使用押金策略';
$_LANG['04_member_group'] = '会员群组组管理';
$_LANG['03_deposit_violate_city_list']='城市默认违章押金';
$_LANG['04_deposit_violate_group_list']='群组默认违章押金';
$_LANG['05_deposit_violate_user_type_list']='类别默认违章押金';
$_LANG['06_deposit_violate_list']='特殊违章押金';
$_LANG['07_time_rent_discount']='时间租金/押金折扣配置';
$_LANG['08_after_pay_group']='后付费群组设置';


/*违章管理*/
$_LANG['01_violate_list']='违章列表';
$_LANG['02_violate_add']='添加违章信息';
$_LANG['05_member_buy_rank']='会员消费等级';
$_LANG['06_revise_fee']='修订费策略';
$_LANG['07_cancel_orderform']='取消订单计费策略';

/*会员奖章*/
$_LANG['17_user_medal']='会员奖章管理';
?>