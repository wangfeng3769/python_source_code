...
新鲜事图片链接：<input type="text" value="http://fmn.rrimg.com/fmn060/20111228/0020/p_head_1GGB_6ea1000021b3121b.jpg" id="image" /><br/>
	...
	function sendFeed() {
		...
		var uiOpts = {
		  ...
		  params : {
			...
			"access_token":'<?=$_SESSION["access_token"]?>'//如果不传此参数的话，display只能改成popup的形式，弹出页面而不是弹层
		  },
		  //style : style,
