 ...
 */
// //测试用判断,正式环境时去掉判断
// if (!empty($_REQUEST['order_id']) || strpos($_REQUEST['orderNumber'], '-')>-1 || isset($_REQUEST['act']))  {

//     // throw new Exception("测试环境成功", 1);
//     require_once(dirname(__FILE__).'/../conf/quickpay_conf_test.php');
...
//     // throw new Exception("测试环境失败", 1);  
//     require_once(dirname(__FILE__).'/../conf/quickpay_conf.php');  
