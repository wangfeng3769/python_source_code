...
class upmp_config
{
    ...
    static $mer_back_end_url        = "http://123.114.99.125/sns/PayAPI/upmp/run/callback.php"; // 后台通知地址
    static $mer_front_end_url       = "http://123.114.99.125/sns/PayAPI/UPPop/example/router.php?notify=fb"; // 前台通知地址
